...
public class SpringBootRelationalDataaccessApplication implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(SpringBootRelationalDataaccessApplication.class);
    ...
    public void run(String... args) throws Exception {
        ...
        List<Object[]> splitUpNames = Arrays.asList("John Woo", "Jeff Dean", "John Bloch", "Josh Long").stream()
                .map(name -> name.split(" "))
